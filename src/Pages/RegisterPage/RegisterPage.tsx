...
import {
  Alert, AuthenticationService, SocialMedia, Page, Input, getEventStatus, EventStatus,
  replacePlaceholders, dateFormat, DateFormat, registrationStartDate, RegisterTeamRequestBody,
  ErrorBodyResponse, EmailRegexString
} from "../../Library";
          ...
          </div>
          {
            getEventStatus() === EventStatus.RegistrationOpen && (
              <form id="register_form" className="section--column-0" onSubmit={handleSubmit} noValidate>
                ...
                <Input pageText={pageText.registrationOpen.form.email} id="email" name="email" type="email" icon="/Assets/add-circle.svg" onIconClick={handleIconClick} showError={false} maxLength={60} inputDisabled={inputsDisabled || pickedEmails.length === 3} pattern={EmailRegexString} />
